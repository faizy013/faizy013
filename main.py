...
# =========================================================================
# INFORMATION YOU NEED TO PROVIDE (see comments marked >>> below):
#   1. ACCESS_TOKEN  -> set as a GitHub Actions secret (never hardcode it)
#   2. USER_NAME     -> your GitHub username, set as env var in the workflow
#   3. Your birth date -> edit the datetime.datetime(...) call in __main__
# =========================================================================
...
USER_NAME = os.environ['USER_NAME']  # 'faizy013'
...
def cache_builder(edges, comment_size, force_cache, loc_add=0, loc_del=0):
    edges = [edge for edge in edges if edge['node'] is not None]
    cached = True
...
if __name__ == '__main__':
    ...
    # >>> STEP 1: SET YOUR OWN BIRTH DATE HERE (year, month, day) <<<
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2004, 10, 13))
